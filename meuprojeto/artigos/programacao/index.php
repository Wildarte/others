<?php
    ...
    include '../../header.html';
?>
    <header class="jumbotron" style="border-radius: 0px; background-image: url('/meuprojeto/imagens/resources/HTML.png');">
    <h1 class="text-center text-white">Programação</h1>
