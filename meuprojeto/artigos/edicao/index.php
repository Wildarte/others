<?php
    ...
    include '../../header.html';
?>
    <header class="jumbotron" style="border-radius: 0px; background-image: url('/meuprojeto/imagens/resources/edicao.png');">
    <h1 class="text-center text-white">Edição e Design</h1>
    </header>
