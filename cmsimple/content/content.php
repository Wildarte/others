...
<p><img class="tplge_right" src="userfiles/images/coffee.png" alt="">Congratulations on your new installation of <strong>CMSimple</strong>. You can login now with the default password, which you will find in the readme.php of the download.</p>
<p>This is the new CMSimple 5, as you get it "out of the box". You see the standard contents and the default template of CMSimple 5.</p>
...
<hr>
<h2 style="font-size: 18px;"><img src="userfiles/images/flags/en.gif" alt="" width="18" height="12"> !!! Important Hint !!!</h2>
<p>Please <strong>DO NOT</strong> change the password directly in config.php by using a text editor. Change the default password right away after login <strong>ONLINE</strong>.</p>
...
<hr>
<h2 style="font-size: 18px;"><img src="userfiles/images/flags/de.gif" alt="" width="18" height="12"> !!! Wichtiger Hinweis !!!</h2>
<p>Bitte ändern Sie das Standard Passwort <strong>NICHT</strong> direkt in der config.php mit einem Text Editor. Ändern Sie das Standard Passwort nach dem Login <strong>ONLINE.</strong></p>
